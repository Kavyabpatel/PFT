...
const exportPDF = async (req, res) => {
    try {
        ...
        const filename = `FinTracker_Pro_Statement_${new Date().toISOString().slice(0, 10)}.pdf`;
        ...
        doc.fillColor(slate500)
           .fontSize(9)
           .font('Helvetica-Bold')
           .text('FINTRACKER PRO', 40, 42, { characterSpacing: 2 });
        ...
        for (let i = 0; i < pages.count; i++) {
            ...
            doc.fontSize(8)
               .fillColor(slate400)
               .font('Helvetica')
               .text('Generated by FinTracker Pro', 40, 768);
